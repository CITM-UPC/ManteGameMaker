...
void ModuleRenderer::keysInputFPS()
{
	...
	{
		App->gEngine->cam.transform.Move(glm::dvec3(0, camSpeed, 0), MatrixLogic::Space::GLOBAL);
	}
...
void ModuleRenderer::mouseInputFPS()
{
	...
	App->gEngine->cam.transform.Rotate(glm::vec3(0, dx * sensitivity, 0), MatrixLogic::Space::GLOBAL);
...
void ModuleRenderer::mouseCamOrbit()
{
	...
	App->gEngine->cam.transform.Rotate(vec3(0, dx * sensitivity, 0), MatrixLogic::Space::GLOBAL);
