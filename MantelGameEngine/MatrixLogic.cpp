...
void MatrixLogic::MoveTo(vec3 position, Space referenceFrame)
{
...
void MatrixLogic::Move(vec3 displacement, Space referenceFrame)
{
...
void MatrixLogic::RotateTo(vec3f axis)
{
...
void MatrixLogic::Rotate(vec3f axis, Space referenceFrame)
{
